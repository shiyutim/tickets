...
import { runtime, saveSettings, openExternal, errorText, call, desktop } from "../services/runtime";
...
const refreshing = computed(() => Object.values(runtime.subscriptions).some(source => source.loading));
function updateProxy(settings) { Object.assign(form, settings); dirty.value = true; }
...
async function checkUpdate() {
    ...
    try {
        const release = await call("get_repo_release");
